...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    FutureOfVoidToJSPromise_get_toJS(_this) {
      return type$.JSObject._as(new init.G.Promise(A._functionToJS2(new A.FutureOfVoidToJSPromise_get_toJS_closure(_this))));
    },
    ...
    JSOBJ_keys_(val) {
      var t1 = type$.nullable_JSArray_nullable_Object._as(init.G.Object.keys(val));
      if (t1 == null)
        t1 = null;
      else {
    ...
    JSWalletEvent_toEvent(_this) {
      ...
      try {
        ...
        B.JSArray_methods.firstWhere$1(B.List_zqX, new A.JSWalletEvent_toEvent_closure(_this));
    ...
    WalletPromise_get_toPromise(_this, $T) {
      return type$.JSObject._as(new init.G.Promise(A._functionToJS2(new A.WalletPromise_get_toPromise_closure(_this))));
    },
    QuickJS_toProxy(_this, $T) {
      return A.callConstructor(init.G.Proxy, [_this, new A.QuickJS_toProxy_closure(new A.ProxyMethodHandler(null, _this, $T._eval$1("ProxyMethodHandler<0>"))).call$0()], type$.JSObject);
    },
    ...
    postToWallet(data, target) {
      ...
      if (target === B.JSWebviewTraget_1) {
        t1 = type$.JSObject;
        t1._as(t1._as(t1._as(t1._as(init.G.window).webkit).messageHandlers).onChain).postMessage(A.jsify(A.LinkedHashMap_LinkedHashMap$_literal(["id", A._asString(data.clientId), "requestId", A._asString(data.requestId), "data", A._asString(data.data), "type", A._asString(data.type)], type$.String, type$.dynamic)));
        return;
      }
      type$.JSObject._as(init.G.onChain).onChainInternalJsRequest(A._asString(data.clientId), A._asString(data.data), A._asString(data.requestId), A._asString(data.type));
    },
    main(args) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t2._as(t1.onChain).onWebViewMessage = A._functionToJS1(new A.main_onActivation(new A._AsyncCompleter(t3, type$._AsyncCompleter_Record_2_JSObject_and_JSWebviewTraget), client));
              $async$goto = 2;
            ...
            case 2:
              ...
              t2._as(t1.onChain).onWebViewMessage = null;
              ...
              t2._as(t1.onChain).onWebViewMessage = A._functionToJS1(new A.main_onWalletEvent(worker));
    ...
    OnChainWallet_get_clientId(_this) {
          ...
          switch ($async$goto) {
            ...
            case 8:
              ...
              if (_this.transactionBlock != null) {
                ...
                t1 = type$.JSObject;
                _this0.account = A._asString(t1._as(_this.account).address);
                _this0.transaction = A._asString(t1._as(init.G.JSON).stringify(transactionJson0));
                _this0.requestType = A._asStringQ(_this.requestType);
                t1 = _this.options;
                t1 = t1 == null ? null : A.JSSuiTransactionBlockResponseParams_clone(t1);
                _this0.options = t1;
  ...
  A.FutureOfVoidToJSPromise_get_toJS__closure0.prototype = {
    call$2(error, stackTrace) {
      ...
      t1 = ["Dart exception thrown from converted Future. Use the properties 'error' to fetch the boxed error and 'stack' to recover the stack trace."];
      t1 = A.callConstructor(errorConstructor, t1, type$.JSObject);
    ...
    $get$3(object, prop, receiver) {
      ...
      if (t2 === true)
        if (!t1 && typeof prop === "string")
          if (B.JSString_methods.startsWith$1(A._asString(A.dartify(prop)), "is")) {
  ...
  A.QuickJS_toProxy_closure.prototype = {
    call$0() {
      ...
      t3 = t2._as(t1.Object);
      _objectMapping = t2._as(t3.create.apply(t3, [null]));
      _objectMapping.get = A._functionToJS0(new A.QuickJS_toProxy__closure0(_dartInstance));
      t1 = t2._as(t1.Object);
      t1.defineProperty.apply(t1, [_jsExporter, "object", _objectMapping]);
      return _jsExporter;
    },
    $signature: 7
  };
  ...
  A.JSBasePageController.prototype = {
    ...
    get$_networks() {
      ...
      if (value === $) {
        ...
        result = A.LinkedHashMap_LinkedHashMap$_literal([B.JSClientType_Ethereum_ethereum, new A.EthereumPageController(t5, t1, t6), B.JSClientType_Tron_tron, new A.TronPageController(t8, t9, t7, t10), B.JSClientType_Solana_solana, new A.SolanaPageController(t11, t12), B.JSClientType_TON_ton, new A.TonPageController(t13, t14), B.JSClientType_Stellar_stellar, new A.StellarPageController(t15, t16), B.JSClientType_Substrate_substrate, new A.SubstratePageController(t18, t17, t19), B.JSClientType_Aptos_aptos, new A.AptosPageController(A.LinkedHashMap_LinkedHashMap$_literal([B.JSEventType_0, A._setArrayType([], t2), B.JSEventType_1, A._setArrayType([], t2)], t3, t4), t20, A.LinkedHashMap_LinkedHashMap$_literal([B.JSEventType_0, A._setArrayType([], t2), B.JSEventType_1, A._setArrayType([], t2), B.JSEventType_5, A._setArrayType([], t2)], t3, t4)), B.JSClientType_Sui_sui, new A.SuiPageController(_this.get$requestController(), A.LinkedHashMap_LinkedHashMap$_literal([B.JSEventType_0, A._setArrayType([], t2), B.JSEventType_1, A._setArrayType([], t2), B.JSEventType_5, A._setArrayType([], t2)], t3, t4)), B.JSClientType_Cosmos_cosmos, new A.CosmosPageController(_this.get$requestController(), A.LinkedHashMap_LinkedHashMap$_literal([B.JSEventType_0, A._setArrayType([], t2), B.JSEventType_1, A._setArrayType([], t2), B.JSEventType_5, A._setArrayType([], t2)], t3, t4)), B.JSClientType_Bitcoin_bitcoin, new A.BitcoinPageController(_this.get$requestController(), A.LinkedHashMap_LinkedHashMap$_literal([B.JSEventType_0, A._setArrayType([], t2), B.JSEventType_1, A._setArrayType([], t2), B.JSEventType_5, A._setArrayType([], t2)], t3, t4))], type$.JSClientType, type$.WalletStandardPageController);
    ...
    _initControllers$0() {
      var i, page, e, s, e0, s0, t1, t2, t3, t4, t5, t6, t7, t8, value, exception, _this = this,
        _s28_ = "Initializing wallet failed: ";
      try {
        for (t1 = _this.get$_networks(), t1 = new A.LinkedHashMapEntriesIterable(t1, A._instanceType(t1)._eval$1("LinkedHashMapEntriesIterable<1,2>")).get$iterator(0), t2 = type$.JSObject, t3 = init.G, t4 = type$.JSArray_JavaScriptFunction, t5 = _this.get$postMessage(), t6 = type$.String, t7 = type$.PageRequestCompleter; t1.moveNext$0();) {
          t8 = t1.__js_helper$_current;
          t8.toString;
          i = t8;
          try {
            page = i.value;
            ...
            if (value === $) {
              ...
              if (value === $) {
                value !== $ && A.throwLateFieldADI("requestController");
                value = _this.__JSBasePageController_requestController_FI = new A.PageRequestController(t5, A.LinkedHashMap_LinkedHashMap$_empty(t6, t7));
              }
              t8 = A._setArrayType([], t4);
              _this.__JSBasePageController__walletStandardController_FI !== $ && A.throwLateFieldADI("_walletStandardController");
              value = _this.__JSBasePageController__walletStandardController_FI = new A.JSPageWalletStandardController(value, {}, {}, t8);
            }
            page._initNetworkFeatures$1(value._feature);
          } catch (exception) {
            e = A.unwrapException(exception);
            s = A.getTraceFromException(exception);
            t2._as(t3.console).error(_s28_ + i.key.networkName + " " + A.S(e) + " " + A.S(s));
          }
        }
        ...
        type$.JSObject._as(init.G.console).error(_s28_ + A.S(e0) + " " + A.S(s0));
      }
    },
  ...
  A.JSWithWorkerPageController.prototype = {
    postMessage$1(message) {
      return this.postMessage$body$JSWithWorkerPageController(message);
    },
    postMessage$body$JSWithWorkerPageController(message) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$self = this, t1;
  ...
  A.JSPageWalletStandardController__initController_closure0.prototype = {
    call$1(_) {
      type$.Object._as(_);
      type$.JSObject._as(init.G.window).dispatchEvent(this.event);
    },
    $signature: 15
  };
  ...
  A.CosmosPageController__getOfflineSignerOnlyAmino_signAmino.prototype = {
    call$2(signerAddress, signDoc) {
      ...
      t1._as(signDoc);
      _this = {};
      _this.signDoc = A._asString(type$.JSObject._as(init.G.JSON).stringify(signDoc));
      _this.signerAddress = signerAddress;
      _this.chainId = this.chainId;
      _this.signOption = this.signOption;
  ...
  A.EthereumPageController.prototype = {
    ...
    _initController$0() {
      ...
      t2 = type$.JSObject;
      proxy0 = A.QuickJS_toProxy(t1, t2);
      proxy = proxy0;
      try {
        init.G.ethereum = proxy;
      } catch (exception) {
        t2._as(init.G.console).error("failed to set ethereum ");
      }
  ...
  A.SubstratePageController.prototype = {
    ...
    _initJsPolkadotAdapter$0() {
      var _this0, _this1, _this2, _this3, _this = this,
        t1 = _this._substrate;
      if (t1 == null) {
        _this0 = {};
        _this1 = {};
        ...
        t1 = _this._substrate = new A.ProxyMethodHandler(null, _this3, type$.ProxyMethodHandler_Object);
      }
  ...
  A.SubstratePageController__initJsPolkadotAdapter_closure.prototype = {
    call$0() {
      ...
      t3 = type$.JSObject;
      t4 = t3._as(t2.Object);
      _jsExporter = t3._as(t4.create.apply(t4, [null]));
      _jsExporter.set = A._functionToJS4(t1.get$set());
      _jsExporter.get = A._functionToJS3(t1.get$get());
      t4 = t3._as(t2.Object);
      _debugKeyMapping = t3._as(t4.create.apply(t4, [null]));
      ...
      t4 = t3._as(t2.Object);
      _objectMapping = t3._as(t4.create.apply(t4, [null]));
  ...
  A.TronPageController.prototype = {
    ...
    onWalletEvent$1(message) {
      var t1, data, events, t2, t3, t4, t5, t6, t7, t8, _i, account, t9, t10, t11, t12, chainChanged, _this = this, _null = null;
      _this.super$WalletStandardPageController$onWalletEvent(message);
      t1 = type$.JSObject;
      data = t1._as(message.data);
      events = A.JSWalletNetworkEvent_get_eventTypes(data);
      for (t2 = events.length, t3 = type$.nullable_JSObject, t4 = init.G, t5 = type$.String, t6 = type$.nullable_Object, t7 = type$.dynamic, t8 = _this._address, _i = 0; _i < events.length; events.length === t2 || (0, A.throwConcurrentModificationError)(events), ++_i)
        switch (events[_i]) {
          case B.JSNetworkEventType_3:
            ...
            if (t11 != (t12 ? _null : A._asString(account.address))) {
              ...
              if (t9 == null)
                t9 = false;
              t8.hex = t9;
              t1._as(t4.window).postMessage(A.jsify(A.LinkedHashMap_LinkedHashMap$_literal(["message", A.LinkedHashMap_LinkedHashMap$_literal(["action", "accountsChanged", "data", account], t5, t6), "source", "contentScript"], t5, t7)));
            }
            break;
          case B.JSNetworkEventType_4:
          ...
          case B.JSNetworkEventType_2:
            ...
            if (chainChanged != null) {
              if (data.disconnect == null) {
                ...
                t1._as(t4.window).postMessage(A.jsify(A.LinkedHashMap_LinkedHashMap$_literal(["message", A.LinkedHashMap_LinkedHashMap$_literal(["action", "connect", "data", null], t5, t6), "source", "contentScript"], t5, t7)));
              }
              t9 = A._asString(chainChanged.fullNode);
              t10 = _this._tronWeb;
              if (t10 != null)
                t10.fullNode = new t4.TronWeb.providers.HttpProvider(t9);
              t10 = _this._tronWeb;
              if (t10 != null)
                t10.solidityNode = new t4.TronWeb.providers.HttpProvider(t9);
              t10 = _this._tronWeb;
              if (t10 != null)
                t10.setEventServer(new t4.TronWeb.providers.HttpProvider(t9));
              _this._eventTIPListeners$2$jsObject(B.JSEventType_1, A._asString(chainChanged.chainId));
              t1._as(t4.window).postMessage(A.jsify(A.LinkedHashMap_LinkedHashMap$_literal(["message", A.LinkedHashMap_LinkedHashMap$_literal(["action", "setNode", "data", A.LinkedHashMap_LinkedHashMap$_literal(["node", chainChanged], t5, t3)], t5, t6), "source", "contentScript"], t5, t7)));
            }
            break;
        }
    },
  ...
  A.main_onActivation.prototype = {
    call$1(data) {
      var walletEvent, target, t2, t3, blob, obj, worker,
        t1 = type$.JSObject;
      t1._as(data);
      walletEvent = A.JSWalletEvent_toEvent(data);
      if (walletEvent == null || walletEvent.clientId !== A.OnChainWallet_get_clientId(t1._as(init.G.onChain)))
        return false;
      ...
      t2.toString;
      A.printString("\x1b[33mload from blob\x1b[0m");
      t3 = init.G;
      blob = t1._as(new t3.Blob(A._setArrayType([t2], type$.JSArray_String), {type: "application/javascript"}));
      obj = A._asString(t3.URL.createObjectURL(blob));
      worker = t1._as(new t3.Worker(obj, {name: "js"}));
    ...
    call$1($event) {
      ...
      switch (A.JSWorkerType_fronName(A._asStringQ(workerEvent.type))) {
        ...
        case B.JSWorkerType_4:
          ...
          A.postToWallet(A.JSWorkerWalletData_constructor_(A.OnChainWallet_get_clientId(t1._as(t4.onChain)), "", "", "activation"), t3);
          break;
        case B.JSWorkerType_2:
          ...
          if (A._asStringQ(error.message) != null)
            t1._as(init.G.console).error(A._asStringQ(error.message));
          t2 = _this.pageController._wait;
          if (t2 != null)
            t2.completeError$1(error);
          _this.workerCompleter.completeError$1(error);
          t1 = A.OnChainWallet_get_clientId(t1._as(init.G.onChain));
  ...
  (function installTearOffs() {
    ...
    var _;
    _instance(_ = A.ProxyMethodHandler.prototype, "get$set", 0, 4, null, ["call$4"], ["$set$4"], 47, 0, 0);
    _instance(_, "get$get", 0, 3, null, ["call$3"], ["$get$3"], 45, 0, 0);
    _instance_1_u(A.JSWithWorkerPageController.prototype, "get$postMessage", "postMessage$1", 8);
    _instance_2_u(_ = A.JSPageWalletStandardController.prototype, "get$_onEvents", "_onEvents$2", 43);
    _instance(_, "get$_connect", 0, 0, null, ["call$1", "call$0"], ["_connect$1", "_connect$0"], 67, 0, 0);
    ...
    _instance(_, "get$_signAndSendAllTransactions", 0, 1, null, ["call$2", "call$1"], ["_signAndSendAllTransactions$2", "_signAndSendAllTransactions$1"], 55, 0, 0);
    ...
    _instance_1_u(_, "get$_signMessage", "_signMessage$1", 0);
    _instance(_ = A.SubstratePageController.prototype, "get$_knownMetadata", 0, 0, null, ["call$1", "call$0"], ["_knownMetadata$1", "_knownMetadata$0"], 56, 0, 0);
    ...
    _instance(_, "get$_connect", 0, 0, null, ["call$1", "call$0"], ["_connect$1", "_connect$0"], 22, 0, 0);
    _instance(_, "get$_connectProvider", 0, 0, null, ["call$1", "call$0"], ["_connectProvider$1", "_connectProvider$0"], 22, 0, 0);
    _instance(_, "get$update", 0, 0, null, ["call$1", "call$0"], ["update$1", "update$0"], 22, 0, 0);
    ...
    _instance_1_u(_, "get$_sendTransaction", "_sendTransaction$1", 0);
    _instance_1_u(_, "get$_signMessage", "_signMessage$1", 0);
    _instance_1_u(_ = A.TronPageController.prototype, "get$_disabledFeature", "_disabledFeature$1", 60);
    _instance(_, "get$_signMessageV2", 0, 1, null, ["call$2", "call$1"], ["_signMessageV2$2", "_signMessageV2$1"], 9, 0, 0);
    _instance(_, "get$_signTransaction_", 0, 1, null, ["call$2", "call$1"], ["_signTransaction_$2", "_signTransaction_$1"], 9, 0, 0);
    _instance(_, "get$_multiSign", 0, 1, null, ["call$2", "call$1"], ["_multiSign$2", "_multiSign$1"], 9, 0, 0);
  ...
  (function inheritance() {
    ...
    _inheritMany(A._Enum, [A.WalletEventTypes, A.WalletEventTarget, A.JSAptosWalletStandardUserResponseStatus, A.JSWalletMessageType, A.JSNetworkEventType, A.JSEventType, A.JSWalletResponseType, A.JSClientType, A.PageRequestType, A.JSWorkerType, A.JSWebviewTraget]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["JSObject(JSObject)", "JSObject(Object)", "~()", "JSObject()", "0&()", "~(String,JavaScriptFunction)", "String()", "Object()", "~(JSObject)", "JSObject(Object[Object?])", "Null(@)", "~(@)", "Null(Object,StackTrace)", "Object?(Object?)", "String(String)", "Null(Object)", "String?()", "Object?()", "~(~())", "~(JavaScriptFunction)", "Object(Object)", "JSObject(String[Object?])", "JSObject([Object?])", "~(@,@)", "bool(JSEventType)", "Null()", "@(@)", "JSObject(String,Object)", "Null(JSObject)", "Null(JavaScriptFunction,JavaScriptFunction)", "JSObject(String)", "bool(JSObject)", "bool(String,@)", "Object(Object,StackTrace)", "~(Object?,Object?)", "~(String,int)", "bool(JSWalletMessageType)", "bool(JSNetworkEventType)", "bool(WalletEventTarget)", "bool(JSWalletResponseType)", "bool(JSClientType)", "bool(JSWorkerType)", "Future<~>()", "JavaScriptFunction?(String,JavaScriptFunction)", "~(String,int?)", "Object?(Object,Object?,Object?)", "int(int,int)", "bool(Object,Object?,Object?,Object?)", "Object?(~)", "@(String)", "int(int)", "String(int)", "bool(JSAptosWalletStandardUserResponseStatus)", "Null(~())", "bool(WalletEventTypes)", "JSObject(JSArray<Object?>[JSObject?])", "JSObject([bool?])", "~(int,@)", "JSArray<Object?>(JSObject)", "Future<JSObject?>()", "~(Object?)", "@(@,String)", "bool(JSWebviewTraget)", "JSNetworkEventType(String)", "String(JSObject)", "Null(@,StackTrace)", "Future<JSObject>()", "JSObject([JSObject?])"],
...
;
    ...
    B.List_zqX = A._setArrayType(makeConstList([B.WalletEventTarget_0, B.WalletEventTarget_1, B.WalletEventTarget_2]), A.findType("JSArray<WalletEventTarget>"));
