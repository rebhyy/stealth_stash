...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1664: (x0,x1) => x0.item(x1),
      _1665: f => finalizeWrapper(f, function() { return dartInstance.exports._1665(f,arguments.length) }),
      _1666: f => finalizeWrapper(f, function() { return dartInstance.exports._1666(f,arguments.length) }),
      _1667: f => finalizeWrapper(f, function() { return dartInstance.exports._1667(f,arguments.length) }),
      _1669: (x0,x1) => x0.writeText(x1),
      _1670: x0 => x0.readText(),
      _1672: x0 => x0.mediaDevices,
      _1673: x0 => x0.userAgent,
      _1674: x0 => x0.onLine,
      _1675: x0 => x0.credentials,
      _1676: (x0,x1,x2,x3,x4) => x0.share(x1,x2,x3,x4),
      _1677: x0 => x0.clipboard,
      _1679: (x0,x1) => x0.getUserMedia(x1),
      _1680: (x0,x1) => x0.detect(x1),
      _1684: x0 => x0.rawValue,
      _1693: x0 => x0.name,
      _1695: x0 => x0.arrayBuffer(),
      _1696: x0 => x0.text(),
      _1698: x0 => x0.length,
      _1699: (x0,x1) => new Blob(x0,x1),
      _1705: x0 => x0.ok,
      _1706: x0 => x0.status,
      _1707: x0 => x0.text(),
      _1713: (x0,x1) => { x0.type = x1 },
      _1724: x0 => x0.target,
      _1732: x0 => x0.data,
      _1733: (x0,x1,x2) => x0.addEventListener(x1,x2),
      _1734: (x0,x1,x2) => x0.removeEventListener(x1,x2),
      _1736: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1736(f,arguments.length,x0) }),
      _1761: (x0,x1) => ({type: x0,alg: x1}),
      _1762: (x0,x1) => ({id: x0,name: x1}),
      _1763: (x0,x1,x2) => ({id: x0,displayName: x1,name: x2}),
      _1764: x0 => x0.id,
      _1765: x0 => x0.type,
      _1766: () => globalThis.PublicKeyCredential.isUserVerifyingPlatformAuthenticatorAvailable(),
      _1769: x0 => x0.response,
      _1771: x0 => x0.clientDataJSON,
      _1772: x0 => x0.authenticatorData,
      _1773: x0 => x0.signature,
      _1777: x0 => x0.getPublicKeyAlgorithm(),
      _1779: (x0,x1) => x0.create(x1),
      _1780: (x0,x1) => x0.get(x1),
      _1781: x0 => ({authenticatorAttachment: x0}),
      _1782: (x0,x1,x2,x3,x4) => ({authenticatorSelection: x0,challenge: x1,pubKeyCredParams: x2,rp: x3,user: x4}),
      _1783: x0 => ({publicKey: x0}),
      _1784: (x0,x1) => ({id: x0,type: x1}),
      _1785: (x0,x1,x2) => ({challenge: x0,allowCredentials: x1,userVerification: x2}),
      _1786: (x0,x1) => ({publicKey: x0,mediation: x1}),
      _1795: x0 => x0.id,
      _1796: (x0,x1) => { x0.id = x1 },
      _1801: (x0,x1) => { x0.autoplay = x1 },
      _1806: (x0,x1) => { x0.href = x1 },
      _1807: (x0,x1) => { x0.target = x1 },
      _1808: (x0,x1) => { x0.download = x1 },
      _1811: (x0,x1) => { x0.srcObject = x1 },
      _1820: (x0,x1) => { x0.accept = x1 },
      _1822: (x0,x1) => { x0.type = x1 },
      _1823: (x0,x1) => { x0.onchange = x1 },
      _1824: (x0,x1) => { x0.onerror = x1 },
      _1825: (x0,x1) => { x0.oncancel = x1 },
      _1826: x0 => x0.files,
      _1827: (x0,x1) => new WebSocket(x0,x1),
      _1828: x0 => x0.readyState,
      _1830: (x0,x1) => x0.send(x1),
      _1832: (x0,x1) => { x0.onclose = x1 },
      _1833: (x0,x1) => { x0.onmessage = x1 },
      _1834: (x0,x1) => { x0.onopen = x1 },
      _1835: x0 => x0.code,
      _1836: x0 => x0.reason,
      _1838: x0 => x0.data,
      _1840: (x0,x1) => x0.get(x1),
      _1841: (x0,x1) => x0.query(x1),
      _1843: (x0,x1,x2) => x0.create(x1,x2),
      _1844: (x0,x1,x2,x3) => x0.update(x1,x2,x3),
      _1845: (x0,x1,x2,x3) => x0.sendMessage(x1,x2,x3),
      _1846: x0 => x0.onActivated,
      _1847: x0 => x0.onUpdated,
      _1848: x0 => x0.onRemoved,
      _1849: (x0,x1,x2,x3,x4,x5,x6) => ({active: x0,autoDiscardable: x1,highlighted: x2,muted: x3,openerTabId: x4,pinned: x5,url: x6}),
      _1850: (x0,x1,x2,x3,x4,x5) => ({active: x0,index: x1,openerTabId: x2,pinned: x3,url: x4,windowId: x5}),
      _1851: (x0,x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11) => ({active: x0,audible: x1,autoDiscardable: x2,currentWindow: x3,discarded: x4,highlighted: x5,index: x6,lastFocusedWindow: x7,muted: x8,pinned: x9,windowId: x10,url: x11}),
      _1853: x0 => x0.active,
      _1861: x0 => x0.favIconUrl,
      _1867: x0 => x0.id,
      _1875: x0 => x0.title,
      _1877: x0 => x0.url,
      _1879: x0 => x0.windowId,
      _1896: x0 => x0.tabId,
      _1897: x0 => x0.windowId,
      _1908: x0 => x0.status,
      _1931: (x0,x1) => x0.create(x1),
      _1932: (x0,x1) => x0.getCurrent(x1),
      _1934: (x0,x1,x2) => x0.get(x1,x2),
      _1935: x0 => x0.onFocusChanged,
      _1937: (x0,x1) => x0.getAll(x1),
      _1938: (x0,x1,x2) => x0.update(x1,x2),
      _1939: (x0,x1,x2,x3,x4,x5,x6,x7,x8) => ({focused: x0,height: x1,incognito: x2,left: x3,tabId: x4,top: x5,url: x6,width: x7,type: x8}),
      _1940: (x0,x1,x2,x3,x4,x5,x6) => ({drawAttention: x0,focused: x1,height: x2,left: x3,state: x4,top: x5,width: x6}),
      _1941: (x0,x1) => ({populate: x0,windowTypes: x1}),
      _1955: x0 => x0.focused,
      _1956: x0 => x0.height,
      _1957: x0 => x0.id,
      _1959: x0 => x0.left,
      ...
      _1970: f => finalizeWrapper(f, function() { return dartInstance.exports._1970(f,arguments.length) }),
      _1971: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1971(f,arguments.length,x0) }),
      _1972: f => finalizeWrapper(f, function() { return dartInstance.exports._1972(f,arguments.length) }),
      _1973: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1973(f,arguments.length,x0) }),
      _1974: () => globalThis.indexedDB,
      _1979: x0 => x0.version,
      _1981: x0 => x0.objectStoreNames,
      _2016: x0 => x0.result,
      _2017: (x0,x1) => { x0.onerror = x1 },
      _2018: (x0,x1) => { x0.onsuccess = x1 },
      _2029: (x0,x1) => { x0.onblocked = x1 },
      _2030: (x0,x1) => { x0.onupgradeneeded = x1 },
      _2043: x0 => x0.value,
      _2049: x0 => x0.session,
      _2058: (x0,x1) => x0.get(x1),
      _2062: (x0,x1) => x0.remove(x1),
      _2066: (x0,x1) => x0.set(x1),
      _2081: (s, m) => {
        try {
      ...
      _2111: o => String(o),
      _2112: (p, s, f) => p.then(s, (e) => f(e, e === undefined)),
      _2113: o => {
      ...
      _2140: (o, p) => o[p],
      _2143: x0 => x0.random(),
      _2144: (x0,x1) => x0.getRandomValues(x1),
      _2145: () => globalThis.crypto,
      _2146: () => globalThis.Math,
      _2147: Function.prototype.call.bind(Number.prototype.toString),
      _2148: Function.prototype.call.bind(BigInt.prototype.toString),
      ...
      _13519: x0 => x0.close(),
      _13521: x0 => x0.open,
      _13522: (x0,x1) => x0.open(x1),
      _13526: (x0,x1) => ({tabId: x0,windowId: x1}),
      _13589: x0 => x0.stop(),
      _13591: x0 => x0.getTracks(),
