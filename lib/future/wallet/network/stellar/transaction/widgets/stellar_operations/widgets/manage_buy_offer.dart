...
class StellarTransactionManageBuyOfferWidget extends StatelessWidget {
  final StellarManageBuyOfferOperationForm form;
  const StellarTransactionManageBuyOfferWidget({required this.form, super.key});
